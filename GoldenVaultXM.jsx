...
function Nav({ page, setPage, open, setOpen, openDeposit }) {
  ...
  <span style={{ color: C.text }}>GOLDEN VAULT </span>
  <span style={{ color: "#ef4444" }}>XM</span>
</div>
      </div>
...
<Btn variant="white" onClick={handleCTA} style={{ color: C.text === "#ffffff" ? "#ffffff" : "#000000" }}        <div style={{ borderLeft: `3px solid ${C.gold}`, paddingLeft: 14, fontSize: 13, color: C.text2, lineHeight: 1.7, marginBottom: 20 }}> Experience access to institutional-grade trading infrastructure engineered for precision, performance, and global market reach across Forex, Crypto, Futures, Commodities, and NFT ecosystems. </div>
